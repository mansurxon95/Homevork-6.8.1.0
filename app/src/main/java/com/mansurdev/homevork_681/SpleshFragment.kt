...
import com.mansurdev.homevork_681.databinding.FragmentSpleshBinding
...
class SpleshFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var anim = AnimationUtils.loadAnimation(binding.root.context, R.anim.anim_splesh)
        binding.textSplesh.startAnimation(anim)
